...
const SEED_LIVE_SESSIONS: LiveSession[] = [
  {
    ...
    courseId: 'course-ds',
    mentorName: 'Vaibhav Ahire',
    title: 'Machine Learning Workflow Live Session',
    description: 'Deep dive into feature scaling, hyperparameter tuning, and cross-validation techniques.',
    date: '2026-07-24',
    startTime: '19:00',
    duration: 90,
  ...
  },
  {
    ...
    courseId: 'course-ds',
    mentorName: 'Vaibhav Ahire',
    title: 'SQL Doubt Solving Q&A',
    description: 'Interactive doubt clearance session on SQL joins, window functions and query optimization.',
    date: '2026-07-26',
    startTime: '20:00',
    duration: 60,
    platform: 'zoom',
...
const SEED_SAVED_RECORDINGS: SavedLiveRecording[] = [
  {
    id: 'rec-seed-1',
    sessionId: 'session-1',
    sessionTitle: 'Machine Learning Workflow Live Session',
    courseId: 'course-ds',
    mentorName: 'Vaibhav Ahire',
    ...
    fileName: 'Machine_Learning_Workflow_Vaibhav_Ahire.webm',
  }
];
...
const SEED_COMMUNITY: CommunityPost[] = [
  {
    ...
    userName: 'Vaibhav Ahire (Mentor)',
    userRole: 'mentor',
    userAvatar: '/uploads/vaibhav_ahire.jpg',
    content: '📢 OFFICIAL ANNOUNCEMENT: Live Q&A Session & Capstone Project Review is scheduled for Saturday at 6:00 PM IST! Attendance is mandatory for all Batch 2026 students.',
    pinned: true,
    reactions: [{ emoji: '🔥', count: 24, users: ['student-ankit', 'stu-3', 'stu-4'] }],
    comments: [],
  ...
  },
  {
    ...
    channelId: 'general',
    userId: 'mentor-vaibhav',
    userName: 'Vaibhav Ahire',
    userRole: 'mentor',
    userAvatar: '/uploads/vaibhav_ahire.jpg',
    content: 'Welcome to the AI Institute Community! Connect with your batchmates, join specialized channels like `#ai-ml-lounge` or `#jobs-referrals`, and keep learning!',
    pinned: true,
    reactions: [{ emoji: '🎉', count: 18, users: ['student-ankit', 'stu-3'] }],
    comments: [
      { id: 'c-1', userId: 'student-ankit', userName: 'Ankit Sharma', userRole: 'student', userAvatar: 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?auto=format&fit=crop&q=80&w=200', content: 'Glad to be here! Excited for the GenAI module.', createdAt: '2026-08-05T10:15:00Z' },
    ],
  ...
  },
  {
    ...
    content: '📚 Shared Resource: Here is the GitHub repository for building LLM Agents from scratch using LangChain & AutoGen!',
    pinned: false,
    reactions: [{ emoji: '⭐', count: 15, users: ['stu-1', 'stu-4'] }],
    comments: [],
  ...
  },
  {
    ...
    userRole: 'student',
    userAvatar: 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?auto=format&fit=crop&q=80&w=200',
    content: '❓ Doubt regarding PyTorch CUDA Out Of Memory during LLaMA-3 fine-tuning. How can I optimize batch size or use LoRA quantization?',
    pinned: false,
    reactions: [{ emoji: '💡', count: 5, users: ['mentor-vaibhav'] }],
    comments: [
      { id: 'c-doubt-1', userId: 'mentor-vaibhav', userName: 'Vaibhav Ahire (Mentor)', userRole: 'mentor', userAvatar: '/uploads/vaibhav_ahire.jpg', content: 'Use QLoRA 4-bit NF4 quantization with BitsAndBytes! Set `gradient_accumulation_steps=4` to reduce memory load.', createdAt: '2026-08-05T16:00:00Z' },
    ],
  ...
  },
  {
    id: 'post-jobs-1',
    courseId: 'course-ds',
    channelId: 'jobs-referrals',
    userId: 'mentor-vaibhav',
    userName: 'Vaibhav Ahire',
    userRole: 'mentor',
    userAvatar: '/uploads/vaibhav_ahire.jpg',
    content: '🚀 JOB OPPORTUNITY: Junior AI Engineer & Data Analyst roles open at Google & TCS (Fresher 0-2 Yrs / Experienced 2+ Yrs). DM your updated resume for direct referral!',
    pinned: true,
    reactions: [{ emoji: '🎯', count: 32, users: ['student-ankit', 'stu-2'] }],
    comments: [],
  ...
  },
  {
    id: 'post-aiml-1',
    courseId: 'course-ds',
    channelId: 'ai-ml-lounge',
    userId: 'student-ankit',
    userName: 'Ankit Sharma',
    userRole: 'student',
    userAvatar: 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?auto=format&fit=crop&q=80&w=200',
    content: '🤖 Who tried running DeepSeek R1 locally with Ollama? The reasoning tokens performance is incredible!',
    pinned: false,
    reactions: [{ emoji: '🧠', count: 14, users: ['mentor-vaibhav'] }],
    comments: [],
  ...
  },
  {
    id: 'post-webdev-1',
    courseId: 'course-ds',
    channelId: 'web-dev-hub',
    userId: 'mentor-vaibhav',
    userName: 'Vaibhav Ahire',
    userRole: 'mentor',
    userAvatar: '/uploads/vaibhav_ahire.jpg',
    content: '⚡ Pro Tip for Next.js 16 App Router: Always use Server Components for data fetching and keep Client Components focused on interactivity!',
    pinned: false,
    reactions: [{ emoji: '💻', count: 19, users: ['student-ankit'] }],
    comments: [],
