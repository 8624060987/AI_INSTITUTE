    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between">
        ...
        <div className="flex items-center gap-2 sm:gap-3">
          ...
          <a
            href="/login/mentor"
            className="flex items-center gap-1.5 px-3 py-2 rounded-xl text-xs font-bold bg-emerald-600/10 hover:bg-emerald-600/20 text-emerald-600 dark:text-emerald-400 border border-emerald-500/30 transition-all cursor-pointer shrink-0"
            title="Access Mentor & Faculty Portal"
          >
            <span>👨‍🏫 Mentor Login</span>
          </a>

          {/* Dedicated Student Login button */}
          <a
